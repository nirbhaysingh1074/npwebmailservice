...
@Component
public class WebmailSeenActionRepository {
...
/*	@Autowired
	...
	public boolean setWebmailSeen(String host, String port, String id, String pass, String foldernm, String uids)
	{
...
public boolean setWebmailUnSeen(String host, String port, String id, String pass, String foldernm, String uids)
	{
        ...
        try 
        {
			...
			for (int i = msg.length-1;  i>=0; i--)
			{
				msg[i].setFlag(Flags.Flag.SEEN, false);
			}
