...
import com.webmail.search.ArrayOfInboxMailQuickSearch;
import com.webmail.search.ArrayOfInboxMailSearch;
import com.webmail.search.InboxListReturnQuickSearch;
import com.webmail.search.InboxListReturnSearch;
import com.webmail.search.InboxQuickSearch;
import com.webmail.search.InboxSearch;


@Component
public class WebmailSearchRepository {
	...
	public InboxListReturnSearch listWebmailSearch(String host, String port, String id, String pass, String start, String end, String foldername, String to_cnt, String from_cnt, String sub_cnt, String cntt, String sdt,  String edt, String tgnm, String stat)
	{
 ...
 for (int i = msg.length-((Integer.parseInt(start))+1),k=0; k< (Integer.parseInt(end)) && i>=0;k++, i--)
  ...
  return   inboxlist;        
	...
	public InboxListReturnQuickSearch listWebmailQuickSearch(String host, String port, String id, String pass, String start, String end, String foldername, String quickval)
	{
		String to_from="";
		String sbjt="";
