...
import com.webmail.ldapuserdirectory.ArrayOfLdapUserDir;
import com.webmail.ldapuserdirectory.LdapDirectory;
import com.webmail.quota.Webmailquota;

import edms.core.Config;

@Component
public class WebmailLdapUserDirectoryRepository {


	public ArrayOfLdapUserDir listLdapUserDirectory(String ldapurl, String uid, String pass, String base)
	{
		
		DirContext ctx=null;
		ArrayOfLdapUserDir arrdir= new ArrayOfLdapUserDir();
		try
		{
		...
		while (results.hasMore()) {
			f=1;
			LdapDirectory dir= new LdapDirectory();
			String mail="";
			String photo="";
			String fn="";
			String mob="";
